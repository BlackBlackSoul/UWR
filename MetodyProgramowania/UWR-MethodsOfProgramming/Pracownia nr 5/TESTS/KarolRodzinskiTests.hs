...
tests =
  ...
  , Test "sourceToFileDivisors" (SrcFile "ppProgramDivisors.pp5") (Eval[15] (Value 3))
  , Test "anotherSrc" (SrcFile "ppProgramDivisors.pp5") (Eval[18] (Value 6))
  , Test "firstElementsOfFib" (SrcFile "fibonacciPro.pp5") (Eval[1] (Value 1))
  , Test "tryAnotherFibNumbers" (SrcFile "fibonacciPro.pp5") (Eval [5] (Value 5)) 
  , Test "toSumUpPairInput" (SrcFile "summingInput.pp5") (Eval[1,2] (Value 3))
  , Test "factorialOfN" (SrcFile "factorial.pp5") (Eval [5] (Value 120))
  , Test "ackermannYouShallNotPass" (SrcFile "ackermann.pp5") (Eval [2, 2] (Value (7)))
  , Test "projectionOfTwoTypes" (SrcFile "rzutowaniePary.pp5") (Eval [1,2] (Value 1))
  , Test "differentTypesPairs" (SrcFile "mixedPairs.pp5") (Eval [5] (Value 10))
  , Test "isEmptyList" (SrcFile "matchingList.pp5") (Eval [1,2,3,4] (Value 1))
  , Test "checkWhetherIsNumber" (SrcFile "matchingList.pp5") (Eval [1,1,1,1] (Value 1))
  , Test "matcherSkrypcix" (SrcFile "matcherSkrypt.pp5") (Eval [] (Value 111))
  , Test "unitFunctions" (SrcFile "fewFuncAndUnit.pp5") (Eval [0,0] (Value 1))
  , Test "defOfModulo" (SrcFile "funMod.pp5") (Eval [12, 3] (Value 0))
  , Test "resztaModJeden" (SrcFile "funMod.pp5") (Eval [12, 11] (Value 1))
  , Test "bladPary" (SrcFile "pairFailType.pp5") TypeError
  , Test "lengthOfTheList" (SrcFile "length.pp5") (Eval [1,1,1,1] (Value 4))
  , Test "baseAndExp" (SrcFile "power.pp5") (Eval [2,4] (Value 16))
  , Test "powerToCatchExcept" (SrcFile "power.pp5") (Eval [1024, 0] (Value 1))
  ]